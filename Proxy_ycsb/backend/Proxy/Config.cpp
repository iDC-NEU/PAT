...
DEFINE_uint64(worker,0, "Number worker threads");
...
DEFINE_uint32(route_mode, 3, " 路由方式（如随机路由）");
...
DEFINE_bool(ycsb_hot_page, true, "enable ycsb_hot_page");
DEFINE_int32(ycsb_hot_page_size, 300, "enable ycsb_hot_page");
DEFINE_int32(edge_weight, 1, " ");