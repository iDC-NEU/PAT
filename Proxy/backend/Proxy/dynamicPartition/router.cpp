...
namespace Proxy
{
    namespace router
    {
        ...
        void Router::metisPart()
        {
            ...
            router_logger.info(fmt::format("初始图划分后顶点数_cluster统计:,{};顶点数_number_of_nodes:{},边数:{}", cnt, DyPartitioner.get_graph().number_of_nodes(), DyPartitioner.get_graph().number_of_edges()));
