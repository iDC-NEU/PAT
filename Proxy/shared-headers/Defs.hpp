...
const std::vector<std::vector<std::string>> NODES{
    ...
    {"172.18.94.80", "172.18.94.10", "172.18.94.70"},                                                  // 3
    {"172.18.94.80", "172.18.94.10", "172.18.94.20", "172.18.94.70"},                                  // 4
    {"172.18.94.80", "172.18.94.10", "172.18.94.20", "172.18.94.40", "172.18.94.70"},                  // 5
    {"172.18.94.80", "172.18.94.10", "172.18.94.20", "172.18.94.40", "172.18.94.30", "172.18.94.70"},  // 6
};
const std::vector<std::vector<uint64_t>> NODESport{
    ...
    {1400, 1500, 1402, 1502, 1602, 1702, 1401}, 
    {1400, 1500, 1402, 1502, 1602, 1702, 1802, 1401},                                                                      // 2
};
